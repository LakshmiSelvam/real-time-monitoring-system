...
const ForgotPasswordPage = () => {
  ...
  const loginFormButtonHandler = async (event) => {
    ...
    if (ErrorUserName === false && ErrorCompanycode === false) {
      let body = {
      ...
      let result = await API.postAPI(URL.forget, body);
      ...
      <div className="right_split_body">
        ...
        {!message ? (
          <div className="right_middle_body">
            <div className="log-in-text">Forgot Password</div>
            <div className="input-container">
              ...
              <span
                data-testid="username-error-field"
          ...
          <div className="redirect-container">
            <div className="redirect-content">
              Link sent to your email, click ok to go login page
            </div>
            <button
